...
> **NOTE:**
>
> Should you take this tutorial first? This tutorial picks up where [First data analysis with Python in a Jupyter Notebook](tutorial-get-started-ipynb.llms.md) leaves off, using the same project. If you have not done that tutorial yet, start there. It takes about 15 minutes and leaves you with a project you can configure here.
...
Here is some more good news: the Microsoft Python and Jupyter extensions you rely on in VS Code are not needed in Positron. Positron provides their functionality natively, with no setup. Out of the box you already have:
...
> **NOTE:**
>
> If an extension you rely on is missing, it might not be published to Open VSX. You can ask its author to [publish it to Open VSX](https://github.com/open-vsx/publish-extensions/blob/master/docs/external_contribution_request.md). See [Add features with extensions](extensions.llms.md) for the full picture.
...
In VS Code you can open a Python REPL in the Terminal or spin up an interactive window for this. Positron gives you the **Console**: a persistent, interactive Python session that is a first-class part of the IDE.
