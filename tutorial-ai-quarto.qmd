...
::: {.callout-note}
Is this the right tutorial to start with? It picks up where [First data analysis with R in a Quarto document](tutorial-get-started-quarto.qmd) and [Migrate from RStudio to Positron](tutorial-migrate-from-RStudio.qmd) leave off. If you have not worked through those, start there. This tutorial assumes you already know how to:
